...
function ReceiptCard({ receipt }) {
  ...
  return (
    <article className="w-full max-w-5xl bg-white rounded-2xl shadow-xl border border-gray-200 overflow-hidden hover:shadow-2xl transition">
      {/* Header */}
      <header className="p-5 flex justify-between items-start border-b border-gray-200">
        <div>
        ...
        <span className="px-4 py-1 text-sm font-medium rounded-full bg-green-100 text-green-800">
          PAID
        </span>
      </header>
      ...
      {/* Receipt Proof */}
      <section className="p-5 border-t border-gray-200">
        <h3 className="font-medium text-gray-800 mb-2">Payment Proof</h3>
        {receipt.receiptUrl ? (
          <div className="space-y-3">
            ...
            <button
              ...
              className="text-sm text-white bg-blue-600 px-4 py-2 rounded-lg hover:bg-blue-700 transition ml-10"
            >
